...
@section('content')
    ...
    <h1 class="font-semibold text-3xl text-center py-5 text-[#3A384C]">Edit Hospital</h1>
    ...
    @endif
    <form action="{{ route('hospital.update', $hospitals->hospital_id) }}" method="POST">
        @csrf
        @method('PUT')
        @include('layouts.hospitaleditform')
    </form>
@endsection